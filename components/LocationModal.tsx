      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          >
            ...
            <ChevronDown
              className={`w-3.5 h-3.5 text-brand-tertiary/60 transition-transform duration-300 stroke-[1.5] shrink-0 ${showAddress ? "rotate-180" : ""}`}
            />
          </button>
        ...
        {showAddress && (
          <div className="bg-brand-secondary/60 p-3.5 rounded-2xl border border-brand-outline/20 space-y-2 animate-in fade-in duration-200">
            ...
            <p className="text-xs text-brand-tertiary leading-relaxed font-normal">{studioAddress}</p>
            <button
              type="button"
              onClick={handleCopy}
